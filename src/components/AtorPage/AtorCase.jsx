            ...
            {industries.map((industry, index) => (
              <div key={index} className="relative group h-full" tabIndex={0}>
                <div className="relative z-10 rounded-xl overflow-hidden h-full">
                  ...
                  {/* Card content */}
                  <div className="relative z-20 bg-black rounded-xl p-7 h-full flex flex-col border border-gray-800 min-h-[460px] lg:min-h-[420px] xl:min-h-[450px] 2xl:min-h-[400px]">
                    {/* Icon with rounded background */}
                    <div className="mb-4 md:mb-7">
                      <div className="w-[50px] h-[50px] md:w-[60px] md:h-[60px] flex items-center justify-center rounded-full bg-[#06CBDE21]">
                        <img
                    ...
                    <h3 className="relative text-lg md:text-2xl  mb-4 md:mb-7 text-white after:block after:h-[2px] after:bg-cyan-400 after:scale-x-0 group-hover:after:scale-x-100 after:origin-left after:transition-transform after:duration-300 w-fit">
                      {industry.title}
                    </h3>
                    ...
                    <button
                      className="text-white text-sm xl:text-lg font-medium hover:text-cyan-300 transition-colors duration-200 flex items-center gap-2 border-b border-white w-fit"
