  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <div className="flex justify-center mb-6 sm:mb-8 lg:mb-10 z-10 relative text-center px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-10 lg:gap-12 z-10 relative">
          ...
          <form
            ...
            noValidate
            className="w-full lg:w-1/2 xl:w-[55%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-8 text-white relative"
          >
            {/* Full Name */}
