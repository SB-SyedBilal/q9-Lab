  ...
  return (
    <section className=" flex justify-center py-10 sm:py-14 bg-black max-w-[1700px] px-6 lg:px-8 mx-auto overflow-hidden">
      ...
      >
        ...
        <p className="text-[#FFFFFF] mb-8 text-[15px] sm:text-[18px] lg:text-md xl:text-lg 2xl:text-2xl">Be part of Q9 Labs’ journey to build applied AI SaaS with global impact.</p>
