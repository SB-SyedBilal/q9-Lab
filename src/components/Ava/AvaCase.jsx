    ...
    >
      <section className="relative  max-w-[1700px] mx-auto py-8 md:py-16 overflow-hidden px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 md:gap-10 xl:gap-14 ">
          {/* Card 1 */}
          <div className="flex flex-col lg:flex-row items-center justify-between bg-gradient-to-b from-[#0E0E0E] to-[#0A0A0A] animated-border rounded-xl p-6 sm:p-8 md:p-10 xl:pb-0 w-full lg:w-[60%] xl:w-[950px] shadow-[0_0_40px_rgba(6,203,222,0.08)]">
            {/* Left Content */}
            <div className="flex flex-col justify-center w-full lg:w-1/2 text-center lg:text-left space-y-4 md:space-y-6">
              <h3 className="text-2xl xl:text-4xl  text-white leading-snug">
                Real Estate Lead
                <br className="hidden sm:block" />
                Qualification
              </h3>
              <p className="text-[#FFFFFF] text-sm 2xl:text-lg leading-relaxed">
          ...
          <div className="flex flex-col justify-center bg-gradient-to-b from-[#0E0E0E] to-[#0A0A0A] animated-border rounded-xl p-6 sm:p-8 md:p-10 w-full lg:w-[40%] xl:w-[550px] shadow-[0_0_40px_rgba(6,203,222,0.08)]">
            <h3 className="text-2xl xl:text-4xl  text-white mb-4 md:mb-6">
              Retail & Travel
              <br className="hidden sm:block" />
              Support
            </h3>
            <p className="text-[#FFFFFF] text-sm 2xl:text-lg  leading-relaxed mb-6 md:mb-8">
