...
export default function HirmBanner() {
    return (
        <section className="relative w-full px-4 py-12 md:py-20 overflow-hidden">
            <CardSpotlight className="m-auto max-w-7xl bg-gradient-to-br p-8 md:p-20 text-center bg-[#0C0C0C] [background-image:radial-gradient(circle_at_bottom_right,_rgba(2,203,222,0.3)_0%,_rgba(2,203,222,0.3)_0%,_transparent_30%)] transition-all duration-300 overflow-hidden animated-border ">
