            ...
            >
                ...
                >
                    ...
                    <div className="relative w-full">
                        <select
                            id="product-intrest"
                            className="w-full appearance-none rounded-md bg-[#252525] px-4 py-5 focus:outline-none 
                         focus:ring-cyan-200 text-gray-400"
                            defaultValue=""
                            placeholder="Select Product On Interest?"
                            {...register("product")}
                            aria-invalid={!!errors.product}
                            aria-describedby={errors.product ? "product-error" : undefined}
                        >
                            <option value="" disabled>Select Product On Interest?</option>
